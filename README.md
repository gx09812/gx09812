...
- Get hands-on with embedded boards (ESP32/Arduino-class projects) tied into IoT dashboards
- Keep combining computer vision with real hardware instead of running it on a webcam only
- Deepen FPGA and VLSI fundamentals toward core digital design work
- Expand networking and embedded Linux projects into full end-to-end systems
